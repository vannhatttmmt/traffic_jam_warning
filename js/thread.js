...
*/
    ...
    window.JSON && window.JSON.stringify || function () {
        ...
        "function" !== typeof JSON.stringify && (JSON.stringify = function (a, c, d) {
            var q;
            p = f = "";
            if ("number" === typeof d) for (q = 0; q < d; q += 1) p += " "; else "string" === typeof d && (p = d);
            if ((m = c) && "function" !== typeof c && ("object" !== typeof c || "number" !==
    ...
    var ca = 1, fa = A, ga = [], ha = "-pnpres", D = 1E3, ia = "/", ja = "&", ka = /{([\w\-]+)}/g;
    ...
    var ma, na = Math.floor(20 * Math.random());
    ma = function (a, d) {
    ...
    function Aa(a, d) {
        var b = 12 <= T ? 3 : 2, c = [], f = [], c = [], f = [], p = a.concat(d), q;
    ...
    function Ba(a, d, b) {
        var d = Ca(d), c = Math.ceil(a.length / 16), f = [], p, q = [];
        for (p = 0; p < c; p++) {
            var m = f, u = p, x = a.slice(16 * p, 16 * p + 16), t = [], r = v, r = v;
    ...
    function Fa(a, d, b, c) {
        var d = Ca(d), f = a.length / 16, p = [], q, m = [], u = "";
    ...
    Pa = hb;
    var db = eb("01020408102040801b366cd8ab4d9a2f5ebc63c697356ad4b37dfaefc591", 2), ab = fb(2), bb = fb(3), $a = fb(9),
        Ua = fb(11), Za = fb(13), Ta = fb(14), ib,
        jb = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", kb = jb.split("");
    "function" === typeof Array.indexOf && (jb = kb);
    ib = {
        encode: function (a) {
            var d = [], b = "", c;
            for (c = 0; c < 16 * a.length; c++) d.push(a[Math.floor(c / 16)][c % 16]);
            for (c = 0; c < d.length; c += 3) b += kb[d[c] >> 2], b += kb[(d[c] & 3) << 4 | d[c + 1] >> 4], b = d[c + 1] !== v ? b + kb[(d[c + 1] & 15) << 2 | d[c + 2] >> 6] : b + "=", b = d[c + 2] !== v ? b + kb[d[c + 2] & 63] : b + "=";
            a = b.slice(0, 64);
            for (c = 1; c < Math.ceil(b.length / 64); c++) a += b.slice(64 * c, 64 * c + 64) + (Math.ceil(b.length / 64) == c + 1 ? "" : "\n");
            return a
        }, decode: function (a) {
            var a = a.replace(/\n/g, ""), d = [], b = [], c = [], f;
            for (f = 0; f < a.length; f += 4) b[0] = jb.indexOf(a.charAt(f)), b[1] = jb.indexOf(a.charAt(f +
                1)), b[2] = jb.indexOf(a.charAt(f + 2)), b[3] = jb.indexOf(a.charAt(f + 3)), c[0] = b[0] << 2 | b[1] >> 4, c[1] = (b[1] & 15) << 4 | b[2] >> 2, c[2] = (b[2] & 3) << 6 | b[3], d.push(c[0], c[1], c[2]);
    ...
    O = {
        ...
        rawDecrypt: Fa,
        dec: function (a, d, b) {
            var a = ib.q(a), c = a.slice(8, 16), c = Aa(za(d, b), c), d = c.key, c = c.i, a = a.slice(16, a.length);
            return a = Fa(a, d, c, b)
        },
        openSSLKey: Aa,
        a2h: function (a) {
        ...
        Hash: {
            MD5: function (a) {
                function d(a, b) {
                    ...
                    return c & d ? g ^ 2147483648 ^ f ^ e : c | d ? g & 1073741824 ? g ^ 3221225472 ^ f ^ e : g ^ 1073741824 ^
                        f ^ e : g ^ f ^ e
                }
                ...
                h = e[2];
                l = e[3];
                for (a = 0; a < m.length; a += 16) u = g, x = j, t = h, r = l, g = b(g, j, h, l, m[a + 0], 7, e[4]), l = b(l, g, j, h, m[a + 1], 12, e[5]), h = b(h, l, g, j, m[a + 2], 17, e[6]), j = b(j, h, l, g, m[a + 3], 22, e[7]), g = b(g, j, h, l, m[a + 4], 7, e[8]), l = b(l, g, j, h, m[a + 5], 12, e[9]), h = b(h, l, g, j, m[a + 6], 17, e[10]), j = b(j, h, l, g, m[a + 7], 22, e[11]), g = b(g, j, h, l, m[a + 8], 7, e[12]), l = b(l, g, j, h, m[a + 9],
                ...
                11], 10, e[65]), h = p(h, l, g, j, m[a + 2], 15, e[66]), j = p(j, h, l, g, m[a + 9], 21, e[67]), g = d(g, u), j = d(j, x), h = d(h, t), l = d(l, r);
    ...
    if (!window.PUBNUB) {
        var lb = function (a, d) {
            ...
            N(a.split(","), function (a) {
                ...
                d.addEventListener ?
                    d.addEventListener(a, f, A) : d.attachEvent ? d.attachEvent("on" + a, f) : d["on" + a] = f
            })
        }, rb = function () {
            return pb("head")[0]
        }, V = function (a, d, b) {
            ...
            function d(a, b) {
                H || (H = 1, e.onerror =
                    z, clearTimeout(Ra), a || !b || Sa(b), setTimeout(function () {
                    a && S();
                    var b = mb(aa), c = b && b.parentNode;
                    c && c.removeChild(b)
                }, D))
            }
            ...
            if (ub || $()) {
                a:{
                    ...
                    }, p = 0, q = 0, m = a.timeout || 1E4, u = setTimeout(function () {
                        j(1, {message: "timeout"})
                    }, m), x = a.b || C(), t = a.data || {}, r = a.c || C(), g = !a.h, j = function (a, c) {
                        p || (p = 1, clearTimeout(u), b && (b.onerror = b.onload = z, b.abort && b.abort(), b = z), a && x(c))
                    };
                    try {
                        b = $() || window.XDomainRequest && new XDomainRequest ||
                            new XMLHttpRequest;
            ...
            var e = tb("script"), f = a.a, aa = la(), H = 0, Ra = setTimeout(function () {
                    d(1, {message: "timeout"})
                },
                a.timeout || 1E4), S = a.b || C(), m = a.data || {}, Sa = a.c || C();
            window[f] = function (a) {
                d(0, a)
            };
            a.h || (e[Bb] = Bb);
            ...
            return a
        }, Bb = "async", ub = -1 == navigator.userAgent.indexOf("MSIE 6");
        window.console || (window.console = window.console || {});
        console.log || (console.log = console.error = (window.opera || {}).postError || C());
        var Eb, Fb = window.localStorage;
        Eb = {
            get: function (a) {
                try {
        ...
        var Gb = {
            ...
            function q(a,
                       b) {
                "object" == typeof a && a.error && a.message && a.payload ? b({
                    message: a.message,
                    payload: a.payload
                }) : b(a)
            }
            ...
            function r() {
                clearTimeout(W);
                !J || 500 <=
                J || 1 > J || !va(B, y).length ? Wa = A : (Wa = y, I.presence_heartbeat({
                    callback: function () {
                        W = setTimeout(r, J * D)
                    }, error: function (a) {
            ...
            function j(a, b, c) {
                var d = A;
                if ("number" === typeof a) d = 5 < a || 0 == a ? A : y; else {
                    if ("boolean" === typeof a) return a ? 30 : 0;
                    d = y
                }
                return d ? (c && c("Presence Heartbeat value invalid. Valid range ( x > 5 or x = 0). Current Value : " + (b || 5)), b ||
                5) : a
            }
            ...
            function h(a) {
                ...
                var d = c.sort(), f;
                for (f in d) {
                    var e = d[f], b = b + (e + "=" + encodeURIComponent(a[e]));
                    f != d.length - 1 && (b += "&")
                }
                return b
            }
            ...
            function aa(a) {
                ...
                var g = 8 * a.length,
                    f = [1116352408, 1899447441, 3049323471, 3921009573, 961987163, 1508970993, 2453635748, 2870763221, 3624381080, 310598401, 607225278, 1426881987, 1925078388, 2162078206, 2614888103, 3248222580, 3835390401, 4022224774, 264347078, 604807628, 770255983, 1249150122, 1555081692, 1996064986,
                        2554220882, 2821834349, 2952996808, 3210313671, 3336571891, 3584528711, 113926993, 338241895, 666307205, 773529912, 1294757372, 1396182291, 1695183700, 1986661051, 2177026350, 2456956037, 2730485921, 2820302411, 3259730800, 3345764771, 3516065817, 3600352804, 4094571909, 275423344, 430227734, 506948616, 659060556, 883997877, 958139571, 1322822218, 1537002063, 1747873779, 1955562222, 2024104815, 2227730452, 2361852424, 2428436474, 2756734187, 3204031479, 3329325298],
                    a = [1779033703, 3144134277, 1013904242, 2773480762, 1359893119, 2600822924, 528734635,
                        1541459225], e = Array(64), l, m, j, h, q, p, r, t, s, w, u;
                d[g >> 5] |= 128 << 24 - g % 32;
                d[(g + 64 >> 9 << 4) + 15] = g;
                for (t = 0; t < d.length; t += 16) {
                    ...
                    p = a[6];
                    r = a[7];
                    for (s = 0; 64 > s; s++) e[s] = 16 > s ? d[s + t] : b(b(b(c(e[s - 2], 17) ^ c(e[s - 2], 19) ^ e[s - 2] >>> 10, e[s - 7]), c(e[s - 15], 7) ^ c(e[s - 15], 18) ^ e[s - 15] >>> 3), e[s - 16]), w = b(b(b(b(r, c(h, 6) ^ c(h, 11) ^ c(h, 25)), h & q ^ ~h & p), f[s]), e[s]), u = b(c(g, 2) ^ c(g, 13) ^ c(g, 22), g & l ^ g & m ^ l & m), r = p, p = q, q = h, h = b(j, w), j = m, m = l, l = g, g = b(w, u);
                    a[0] = b(g, a[0]);
                    a[1] = b(l, a[1]);
                    a[2] = b(m, a[2]);
                    a[3] = b(j, a[3]);
            ...
            a.crypto_obj = {
                encrypt: function (a, b) {
                    if (!b) return a;
                    var c = O.s2a(aa(b).slice(0,
                        32)), d = O.s2a(JSON.stringify(a)), c = O.rawEncrypt(d, c, S);
                    return O.Base64.encode(c) || a
                }, decrypt: function (a, b) {
                    if (!b) return a;
                    var c = O.s2a(aa(b).slice(0, 32));
                    try {
                        var d = O.Base64.decode(a), e = O.rawDecrypt(d, c, S, A);
                        return JSON.parse(e)
                    } catch (f) {
                    }
                }
            ...
            var Sa = +a.windowing || 10, Hb = (+a.timeout || 310) * D, ob = (+a.keepalive || 60) * D,
                ...
                Ob = a.no_wait_for_pending, Pb = a["compatible_3.5"] || A, E = a.xdr, Y = a.params || {},
                s = a.error || C(), Nb = a._is_online || function () {
                    return 1
                }, L = a.jsonp_cb || function () {
                    return 0
                }, ea = a.db || {get: C(), set: C()}, X = a.cipher_key, F = a.uuid || ea && ea.get(w + "uuid") || "",
                ba = a.crypto_obj || {
                    encrypt: function (a) {
                        return a
                    }, decrypt: function (a) {
                ...
                I = {
                    LEAVE: function (a, b, c, d) {
                        var e = {uuid: F, auth: M}, f = ma(oa), c = c || C(), g = d || C(), d = L();
                        if (0 < a.indexOf(ha)) return y;
                        if (Pb && (!Xa || "0" == d) || Lb) return A;
                        "0" != d && (e.callback = d);
                        E({
                            h: b || Xa, timeout: 2E3, a: d, data: l(e), c: function (a) {
                                m(a, c, g)
                            }, b: function (a) {
                                q(a, g)
                    ...
                    _add_param: function (a,
                                          b) {
                        Y[a] = b
                    },
                    history: function (a, b) {
                        var b = a.callback || b, c = a.count || a.limit || 100, d = a.reverse || "false",
                            e = a.error || C(), f = a.auth_key || M, h = a.cipher_key, m = a.channel, j = a.start,
                            p = a.end, r = a.include_token, t = {}, u = L();
                    ...
                    replay: function (a, b) {
                        var b = b || a.callback || C(), c = a.auth_key || M, d = a.source, e = a.destination,
                            f = a.stop, g = a.start, h = a.end, j = a.reverse, q = a.limit, p = L(), r = {};
                    ...
                    time: function (a) {
                        var b = L();
                        E({
                            a: b, data: l({uuid: F, auth: M}), timeout: 5 * D, url: [K, "time", b], c: function (b) {
                                a(b[0])
                            }, b: function () {
                                a(0)
                            }
                    ...
                    publish: function (a, b) {
                        ...
                        var b =
                            b || a.callback || c.callback || C(), d = a.channel || c.channel, e = a.auth_key || M,
                            f = a.cipher_key, g = a.error || c.error || C(), h = a.post || A,
                            j = "store_in_history" in a ? a.store_in_history : y, p = L(), r = "push";
                        a.prepend && (r = "unshift");
                        ...
                        j || (Y.store =
                            "0");
                        Q[r]({
                            a: p, timeout: 5 * D, url: c, data: l(Y), b: function (a) {
                                q(a, g);
                                x(1)
                            }, c: function (a) {
                                m(a, b, g);
                    ...
                    unsubscribe: function (a, b) {
                        var c = a.channel, b = b || a.callback || C(), e = a.error || C();
                        da = 0;
                    ...
                    subscribe: function (a, b) {
                        function e(a) {
                            a ? setTimeout(d, D) : (K = ma(oa, 1), wb = ma(oa, 1),
                                setTimeout(function () {
                                    I.time(e)
                                }, D));
                            u(function (b) {
                                ...
                                Ha = E({
                                    ...
                                    c: function (a) {
                                        ...
                                        if (Ya && !Ja) da = 0, Ya = A, ea.set(w, 0); else {
                                            Q && (da = 1E4, Q = 0);
                                            ea.set(w, a[1]);
                                            var b, c = (2 < a.length ? a[2] : ua(va(B), function (b) {
                                            ...
                                            var e = G() - Va - +a[1] / 1E4;
                                            N(a[0], function (c) {
                                                var d = b(), c = g(c, B[d[1]] ? B[d[1]].cipher_key : z);
                                                d[0](c, a, d[1], e)
                                            })
                                        }
                                        setTimeout(f, Y)
                        ...
                        var h = a.channel, b = (b = b || a.callback) ||
                            a.message, m = a.auth_key || M, j = a.connect || C(), p = a.reconnect || C(),
                            r = a.disconnect || C(), x = a.error || C(), J = a.idle || C(), H = a.presence || 0,
                            P = a.noheresync || 0, Q = a.backfill || 0, X = a.timetoken || 0, aa = a.timeout || Hb,
                            Y = a.windowing || Sa, S = a.state, W = a.heartbeat || a.pnexpires, ba = a.restore || Ja;
                        Ja = ba;
                        da = X;
                        ...
                        N((h.join ? h.join(",") : "" + h).split(","), function (c) {
                            ...
                            B[yb = c] = {
                                name: c, g: d.g,
                                d: d.d, f: 1, a: xb = b, cipher_key: a.cipher_key, n: j, o: r, p: p
                            };
                            S && (Z[c] = c in S ? S[c] : S);
                            H && (I.subscribe({
                                channel: c + ha,
                                ...
                                channel: c, callback: function (a) {
                                    N("uuids" in a ? a.uuids : [], function (b) {
                                        H({
                                            action: "join",
                                            uuid: b,
                                            timestamp: Math.floor(G() / 1E3),
                    ...
                    here_now: function (a, b) {
                        var b = a.callback || b, c = a.error || C(), d = a.auth_key || M, e = a.channel, f = L(),
                            g = a.state, d = {uuid: F, auth: d};
                        if (!("uuids" in
                            a ? a.uuids : 1)) d.disable_uuids = 1;
                        g && (d.state = 1);
                        if (!b) return s("Missing Callback");
                        if (!w) return s("Missing Subscribe Key");
                    ...
                    where_now: function (a, b) {
                        var b = a.callback || b, c = a.error || C(), d = a.auth_key || M, e = L(), f = a.uuid || F,
                            d = {auth: d};
                        if (!b) return s("Missing Callback");
                        if (!w) return s("Missing Subscribe Key");
                        "0" != e && (d.callback =
                    ...
                    state: function (a, b) {
                        var b = a.callback || b || C(), c = a.error || C(), d = a.auth_key || M, e = L(), f = a.state,
                            g = a.uuid || F, h = a.channel, d = l({auth: d});
                        if (!w) return s("Missing Subscribe Key");
                        ...
                        f = f ? [K, "v2", "presence", "sub-key", w, "channel", encodeURIComponent(h),
                            "uuid", g, "data"] : [K, "v2", "presence", "sub-key", w, "channel", encodeURIComponent(h), "uuid", encodeURIComponent(g)];
                        E({
                            a: e, data: l(d), c: function (a) {
                                m(a, b, c)
                            }, b: function (a) {
                    ...
                    grant: function (a, b) {
                        var b = a.callback || b, c = a.error || C(), d = a.channel, e = L(), f = a.ttl,
                            g = a.read ? "1" : "0", j = a.write ? "1" : "0", p = a.auth_key;
                        if (!b) return s("Missing Callback");
                        if (!w) return s("Missing Subscribe Key");
                        if (!P) return s("Missing Publish Key");
                        if (!Ia) return s("Missing Secret Key");
                        var r = w + "\n" + P + "\ngrant\n", g = {
                            w: j, r: g, timestamp: Math.floor((new Date).getTime() /
                                1E3)
                        };
                    ...
                    audit: function (a, b) {
                        var b = a.callback || b, c = a.error || C(), d = a.channel, e = a.auth_key, f = L();
                        if (!b) return s("Missing Callback");
                        if (!w) return s("Missing Subscribe Key");
                        if (!P) return s("Missing Publish Key");
                        if (!Ia) return s("Missing Secret Key");
                    ...
                    presence_heartbeat: function (a) {
                        var b = a.callback || C(), c = a.error || C(), a = L(), d = {uuid: F, auth: M};
                        2 < JSON.stringify(Z).length && (d.state = JSON.stringify(Z));
                        0 < R && 320 > R && (d.heartbeat = R);
                        "0" != a && (d.callback = a);
                        var e = E, d = l(d), f = 5 * D, g = K, h = w, j = va(B, y).join(",");
                        e({
                            a: a,
                            data: d,
                            timeout: f,
        ...
        Jb.init =
            Jb;
        Jb.secure = Jb;
        "complete" === document.readyState ? setTimeout(wa, 0) : qb("load", window, function () {
            setTimeout(wa, 0)
        });
        var Kb = Ib || {};
        PUBNUB = Jb({
            notest: 1,
            publish_key: V(Kb, "pub-key"),
            subscribe_key: V(Kb, "sub-key"),
            ssl: !document.location.href.indexOf("https") || "on" == V(Kb, "ssl"),
            origin: V(Kb, "origin"),
            uuid: V(Kb, "uuid")
        });
        ...
        if (Ib) {
            ...
            if ("opera" in window || V(Ib,
                    "flash")) Ib.innerHTML = "<object id=pubnubs data=https://pubnub.a.ssl.fastly.net/pubnub.swf><param name=movie value=https://pubnub.a.ssl.fastly.net/pubnub.swf><param name=allowscriptaccess value=always></object>";
    ...
    var Mb = PUBNUB.ws = function (a, d) {
        ...
        b.k = c;
        b.e.subscribe({
            restore: A, channel: c.channel, disconnect: b.onerror, reconnect: b.onopen, error: function () {
    ...
    Mb.prototype.send = function (a) {
        var d = this;
        d.e.publish({
            channel: d.e.k.channel, message: a, callback: function (a) {
                d.onsend({data: a})
            }
        })
    };
